...
var centerMenu = [
    ...
    ,{
        name: '服装收藏',
        url: '../fuzhuangCollection/list.html'
    }
    ,{
        name: '服装订单',
        url: '../fuzhuangOrder/list.html'
    }
...
var adminurl =  "http://localhost:8080/fuzhuangshangcheng/admin/dist/index.html#/login";
